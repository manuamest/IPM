...
class RecipeInformation extends StatefulWidget {
  ...
  RecipeInformation(this.recipe, this.search, this.filters, this.meals,
      this.calorieMin, this.calorieMax, this.filterColors, this.mealColors,
      {Key? key})
      : super(key: key);

  @override
  State<RecipeInformation> createState() => _RecipeInformationState(recipe,
...
class _RecipeInformationState extends State<RecipeInformation> {
  ...
  _RecipeInformationState(this.recipe, this.search, this.filters, this.meals,
      this.calorieMin, this.calorieMax, this.filterColors, this.mealColors);
