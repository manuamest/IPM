...
import 'package:edamam/home.dart';
...
class Results extends StatefulWidget {
  ...
  Results(this.search, this.filters, this.meals, this.calorieMin,
...
class _ResultsState extends State<Results> {
  ...
  List<Color> mealColors;
  String? search;
  _ResultsState(this.search, this.filters, this.meals, this.calorieMin,
      this.calorieMax, this.filterColors, this.mealColors);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SizedBox(
          height: maxheight,
          width: maxwidth,
          child: ScrollPagination(search!, filters, meals, calorieMin,
